...
void LinkedList<T>::ListContent(void) {
    ...
    if(this->ListEmpty()) {
        ...
        if(prevPtr == NULL) cout << "prevPtr = " << " NULL ";
        else cout << "prevPtr = " << this->prevPtr->data << " ";
        if(currPtr == NULL) cout << "currPtr = " << " NULL ";
        else cout << "currPtr = " << this->currPtr->data << " ";
        cout << "rear = " << this->rear->data << " ";
...
void LinkedList<T>::InsertFront(const T& item) {
    Node<T> *newNode;
    newNode = GetNode(item,front);	// new node is connected to the front node

    prevPtr = NULL; // prevPtr is NULL
